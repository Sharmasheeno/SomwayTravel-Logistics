...
const paths: Record<SomwayIconName, ReactNode> = {
...
const aliases: Record<string, SomwayIconName> = {
  grid: "dashboard",
  cargo: "box",
  visa: "passport",
  report: "chart",
...
export function SomwayIcon({
  ...
  const resolved = aliases[name] || (name in paths ? name as SomwayIconName : "dashboard");
  return (
